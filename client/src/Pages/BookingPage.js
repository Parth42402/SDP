import { DatePicker, TimePicker, Form, Input, Row, Col, Select, Space, message } from 'antd'
...
export const BookingPage = () => {
    ...
    const getUserdata = async () => {
        try {
            const res = await axios.post('/api/v1/hospital/getHospitalById', { hospitalId: params.hospitalId }, {
                headers: {
                                ...
                                <Form layout='vertical'>
                                    <Row gutter={30}>
                                        ...
                                        <Col xs={24} md={24} lg={8}>
                                            <Form.Item label="Child name" name="child_name" required rules={[{ required: true }]}>
                                        ...
                                        <Col xs={24} md={24} lg={8}>
                                            <Form.Item label="Vaccine" name="vaccine" required rules={[{ required: true }]}>
                                                <Space wrap>
                                                    <Select
                                                        defaultValue="BCG"
                                                        style={{ width: 250 }}
